...
const LOGO_PATH = "./example/basic/in.png";
const TOKEN_NAME = "$IND";
const TOKEN_SYMBOL = "IND";
const TOKEN_DESC = `India joins the fray! 🇮🇳
🌍 Over a billion strong — the 🐅 tiger can’t be ignored.
Will $IND surprise the world and roar to the top? 🔥
💪 Join the movement, support the tiger, and pump together!
🏆 https://memecup.ovh  
